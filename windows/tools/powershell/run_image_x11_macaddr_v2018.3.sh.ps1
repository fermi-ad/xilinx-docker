...
#!/bin/bash
# Run a v2018.3 docker image as a container
# - Uses images built from: 
#   - Dockerfile.vivado_v2018.3
...
docker run `
   ...
   -v d:\srv\sstate-mirrors:/srv/sstate-mirrors `
   -v d:\srv\sstate-cache:/srv/sstate-cache `
   -v d:\srv\tftpboot:/tftpboot `
   -v d:\srv\software\xilinx:/srv/software `
   -v d:\srv\hardware_definitions:/srv/hardware_definitions `
   -v d:\srv\shared:/srv/shared `
