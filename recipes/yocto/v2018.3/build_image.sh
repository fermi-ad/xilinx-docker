...
echo " 	--build-arg YOCTO_DIR=\"${YOCTO_DIR}\""
echo " 	--build-arg YOCTO_VER=\"${YOCTO_VER}\""
echo "  --build-arg YOCTO_MANIFEST_URL=\"${YOCTO_MANIFEST_URL}\""
echo "  --build-arg YOCTO_MANIFEST_BRANCH=\"${YOCTO_MANIFEST_BRANCH}\""
...
docker build $DOCKER_CACHE -f ./$DOCKER_FILE_NAME \
	--target $DOCKER_FILE_STAGE \
 	...
 	--build-arg YOCTO_VER="${YOCTO_VER}" \
 	--build-arg YOCTO_MANIFEST_URL="${YOCTO_MANIFEST_URL}" \
 	--build-arg YOCTO_MANIFEST_BRANCH="${YOCTO_MANIFEST_BRANCH}" \
