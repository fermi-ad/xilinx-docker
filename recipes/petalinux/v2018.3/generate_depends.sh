...
#	- Uses: Dockerfile.petalinux_v2018.3
#
# Maintainer:
...
#	- 12/13/2018
#
# Source configuration for v2018.3 Petalinux builds
...
#Download the Xilinx MALI Binaries from the Xilinx page
...
echo "-----------------------------------"
DOCKER_CONTAINER_NAME=build_petalinux_depends_$XLNX_RELEASE_VERSION
