...
# runtime image  : nvidia/cuda:11.8.0-runtime-ubuntu20.04
# devel image    : nvidia/cuda:11.8.0-devel-ubuntu20.04
# cudnn8 image   : nvidia/cuda:11.8.0-cudnn8-runtime-ubuntu20.04
# cudnn8 image   : nvidia/cuda:11.8.0-cudnn8-devel-ubuntu20.04
#######################################################################################
# base image     : nvidia/cuda:11.8.0-base-ubuntu20.04
...
# CUDNN runtime image  : nvidia/cuda:11.8.0-cudnn8-runtime-ubuntu20.04
...
# CUDNN devel image    : nvidia/cuda:11.8.0-cudnn8-devel-ubuntu20.04
