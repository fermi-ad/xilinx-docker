...
#	- 8/24/2023
#
# Image configuration for ```cuda-10.0-cudnn7-runtime-ubuntu18.04```
#
########################################################################################
...
#   ./depends/cuda/dist/10.0/ubuntu18/base/Dockerfile
#
# - From build script:
...
#   ./depends/cuda/dist/10.0/ubuntu18/runtime/Dockerfile
#
# - From build script:
# Execute Non-CUDAGL build steps
...
#   ./depends/cuda/dist/10.0/ubuntu18/runtime/cudnn7/Dockerfile
#
# - Not in build script:
# Execute Non-CUDAGL build steps
#   run_cmd docker buildx build --pull ${LOAD_ARG} ${PUSH_ARG} ${PLATFORM_ARG} \
#       -t "${IMAGE_NAME}:${CUDA_VERSION}-runtime-${OS}${OS_VERSION}${IMAGE_SUFFIX:+-${IMAGE_SUFFIX}}" \
#       --build-arg "IMAGE_NAME=${IMAGE_NAME}" \
#       "${BASE_PATH}/${OS_PATH_NAME}/runtime/cudnn7"
########################################################################################
...
#   ./depends/cuda/dist/10.0/ubuntu18/devel/Dockerfile
#
# - From build script:
# Execute Non-CUDAGL build steps
#   run_cmd docker buildx build --pull ${LOAD_ARG} ${PUSH_ARG} ${PLATFORM_ARG} \
...
# Step #3b
# - Build the DEVEL CUDA docker image
#   ./depends/cuda/dist/10.0/ubuntu18/devel/cudnn7/Dockerfile
#
# - Not in build script:
# Execute Non-CUDAGL build steps
#   run_cmd docker buildx build --pull ${LOAD_ARG} ${PUSH_ARG} ${PLATFORM_ARG} \
