...
#	- 8/24/2023
#
# Image configuration for ```cuda-11.0.3-runtime-ubuntu18.04```
#
########################################################################################
...
#   ./depends/cuda/dist/11.0.3/ubuntu1804/base/Dockerfile
#
# - From build script:
...
#   ./depends/cuda/dist/11.0.3/ubuntu1804/runtime/Dockerfile
#
# - From build script:
# Execute Non-CUDAGL build steps
...
#   ./depends/cuda/dist/11.0.3/ubuntu1804/runtime/cudnn8/Dockerfile
#
# - Not in build script:
# Execute Non-CUDAGL build steps
#   run_cmd docker buildx build --pull ${LOAD_ARG} ${PUSH_ARG} ${PLATFORM_ARG} \
...
#   ./depends/cuda/dist/11.0.3/ubuntu1804/devel/Dockerfile
#
# - From build script:
# Execute Non-CUDAGL build steps
#   run_cmd docker buildx build --pull ${LOAD_ARG} ${PUSH_ARG} ${PLATFORM_ARG} \
...
# Step #3b
# - Build the DEVEL CUDA docker image
#   ./depends/cuda/dist/11.0.3/ubuntu1804/devel/cudnn8/Dockerfile
#
# - Not in build script:
# Execute Non-CUDAGL build steps
#   run_cmd docker buildx build --pull ${LOAD_ARG} ${PUSH_ARG} ${PLATFORM_ARG} \
