...
# KUbuntu Revision (Focal Fossa) 20.04.3
# Base Tarball Image - N/A
...
ISO_RELEASE_URL=http://cdimage.ubuntu.com/kubuntu/releases/$BASE_OS_VERSION/release
