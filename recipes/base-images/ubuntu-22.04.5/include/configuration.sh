...
# Ubuntu specific
BASE_OS_NAME=ubuntu
BASE_OS_VERSION=22.04.5
BASE_OS_VERSION_CORE=22.04
BASE_OS_CODENAME=jammy
BASE_OS_ARCH=amd64

# Ubuntu Revision (Focal Fossa) 20.04.4
# Base Tarball Image
...
ISO_RELEASE_URL=http://releases.ubuntu.com/releases/$BASE_OS_CODENAME
ISO_RELEASE_IMAGE=$BASE_OS_NAME-$BASE_OS_VERSION-live-server-$BASE_OS_ARCH.iso
#ISO_RELEASE_URL=https://old-releases.ubuntu.com/releases/$BASE_OS_VERSION_CORE
#ISO_RELEASE_IMAGE=$BASE_OS_NAME-$BASE_OS_VERSION-live-server-$BASE_OS_ARCH.iso
...
ISO_RELEASE_SQUASHFS_IMAGE=casper/ubuntu-server-minimal.squashfs
