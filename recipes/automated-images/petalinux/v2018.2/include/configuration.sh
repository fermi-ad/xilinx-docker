...
#XLNX_MALI_BINARY=$INSTALL_DEPENDS_DIR/mali-400-userspace-with-android-2018.2.tar
...
XLNX_PETALINUX_INSTALLER=$INSTALL_DEPENDS_DIR/petalinux-v2018.2-final-installer.run
